...
export const fetchWorkData = async (startDate: string, endDate: string) => {
  let hasMore = true;
...
//#region ======================= [react query ] =============================
export const useWorkData = (startDate: string, endDate: string) => {
  return useQuery({
    queryKey: ["work", startDate, endDate],
    queryFn: () => fetchWorkData(startDate, endDate),

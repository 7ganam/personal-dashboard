...
export const fetchDietData = async (startDate: string, endDate: string) => {
  let hasMore = true;
...
export const useDietData = (startDate: string, endDate: string) => {
  return useQuery({
    queryKey: ["diet", startDate, endDate],
    queryFn: () => fetchDietData(startDate, endDate),
